    ...
    return (
        <Tooltip.Provider delayDuration={200}>
            <div className="relative py-10 space-y-10 md:space-y-16">
                ...
                {/* Mobile: far left (16px) | Desktop: 120px */}
                                ...
                                <div className="pl-8 space-y-3">
                                    ...
                                    <Tooltip.Root>
                                        <Tooltip.Trigger asChild>
                                            <div className="glass-warm p-4 rounded-xl border border-white/5 hover:border-blue-400/30 transition-all cursor-default bg-gradient-to-r from-blue-500/5 to-transparent">
                                        ...
                                        <Tooltip.Portal>
                                            <Tooltip.Content className="z-50 max-w-xs bg-gray-900/95 border border-white/10 text-gray-200 text-sm p-4 rounded-lg shadow-xl backdrop-blur-md" sideOffset={5}>
                                    ...
                                    <Tooltip.Root>
                                        <Tooltip.Trigger asChild>
                                            <div className="glass-warm p-4 rounded-xl border border-white/5 hover:border-rose-400/30 transition-all cursor-default bg-gradient-to-r from-rose-500/5 to-transparent">
                                                <div className="flex items-center gap-3 mb-2">
                            ...
                            <div className="hidden md:flex items-start gap-12">
                                ...
                                <div className="flex-1 space-y-4 pt-1">
                                    ...
                                    <Tooltip.Root>
                                        ...
                                        <Tooltip.Portal>
                                            <Tooltip.Content className="z-50 max-w-xs bg-gray-900/95 border border-white/10 text-gray-200 text-sm p-4 rounded-lg shadow-xl backdrop-blur-md animate-slidedown" sideOffset={5}>
                                                <div className="space-y-2">
                                                    <strong className="block text-blue-400 text-xs uppercase">Key Learning</strong>
                                                    <p>{workRef?.learning}</p>
                                                    {workRef?.improvement && (
